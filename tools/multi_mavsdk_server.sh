...
#
# This script supposes that the mavsdk_server executable is in the parent folder (generated by MAVSDK repo and stored in ../build/default/src/mavsdk_server/src/mavsdk_server)
